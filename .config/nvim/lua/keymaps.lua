...
vim.keymap.set("n", "<leader>ole", "<cmd>silent !open-last-export.sh &<CR>", { desc = 'Open last export' })
vim.keymap.set("n", "<leader>oe", "<cmd>silent !open-export.sh % &<CR>", { desc = 'Open export' })
...
vim.keymap.set("n", "<C-p>", ":lua require('telescope.builtin').find_files()<CR>", { desc = 'Find files' })
